...
const messages = { FORBIDDEN: '当前账号没有此操作权限，请联系管理员。', PERMISSION_DENIED: '当前账号没有此操作权限，请联系管理员。', CONTENT_GOVERNANCE_HOLD: '内容存在治理限制，请先处理相关问题。', LOGIN_RATE_LIMITED: '登录尝试过多，请稍后再试。', UNAUTHORIZED: '登录已过期，请重新登录。', INVALID_CREDENTIALS: '用户名或密码错误。', VERSION_OR_STATE_CONFLICT: '内容已被更新，请刷新后重试。', INVALID_ORDER_TRANSITION: '不能跳过必要步骤，请按流程推进订单。', ORDER_QUOTE_REQUIRED: '报价时必须填写金额、币种和预计工期。', ORDER_PRODUCTION_REQUIRED: '进入制作前必须指定负责人和截止日期。', ORDER_DELIVERABLE_REQUIRED: '提交质检前必须填写成品文件或任务地址。', ORDER_QC_REQUIRED: '平台质检全部通过后才能提交用户验收。', ORDER_DELIVERY_REQUIRED: '完成交付前必须填写最终交付记录。', MEDIA_REVIEW_REQUIRED: '需要先完成素材处理和审核。', PACKAGE_COVER_REQUIRED: '角色视频包必须先上传角色主图。', INVALID_PACKAGE: '请检查名称、视频数量和标签。' };
...
function showView(view) {
  ...
  const titles = { content: ['内容管理', '管理角色内容、创作者投稿与上架进度。'], orders: ['定制订单', '审核需求、分配创作者并跟进制作交付。'], creators: ['创作者管理', '审核创作者资格与管理接单权限。'], audit: ['运营日志', '查看操作记录与操作人。'], operators: ['运营账号', '按岗位创建账号并逐项分配管理权限。'], empty: ['运营工作台', '当前账号尚未分配业务模块。'], layout: ['页面装修', '管理 App 页面模块与发布版本。'] };
