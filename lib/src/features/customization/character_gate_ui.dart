...
abstract final class GateCopy {
  ...
  static const _copy = {
    'zh': {
      ...
      'reviewRequirements': '定制要求',
      'reviewRequirementsHint': '描述动作、风格、细节和希望的交付效果',
    ...
    'en': {
      ...
      'reviewRequirements': 'Customization requirements',
      'reviewRequirementsHint':
          'Describe the motions, style, details, and desired result',
    ...
    'ja': {
      ...
      'reviewRequirements': 'カスタマイズのご要望',
      'reviewRequirementsHint': '動き、スタイル、細部、ご希望の仕上がりをご記入ください',
